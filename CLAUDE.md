...
5. **Query through the service-role API** (a tsx script with `createServiceClient()`), never the
   Supabase connector: its tools prompt Matt and are denied (Matt 2026-09-24). Snapshot first.
