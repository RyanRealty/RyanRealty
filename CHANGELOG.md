...
### Maintenance
- docs(handoff): RC1 complete — inbox now reads the conversation model end-to-end
...
### Features
- feat(crm): inbound dual-write into the conversation model (RC1, spec 02)
...
### Maintenance
- chore(gates): remaining baseline updates for the conversion-audit batch
- chore(gates): restore ci:gates green after the conversion-audit batch
...
### Features
- feat(cma): Expired Audit document type — one engine, three deliverables
...
### Features
- feat(cma,bpo): OWRD water rights + adversarial-audit hardening
...
### Maintenance
- chore(crm): temporary FUB text-thread ingestion endpoint
...
### Maintenance
- docs(design-audit): photo work (CMP-2 hero variety + TRU-5 community photos) complete
...
### Bug Fixes
- fix(cma): year-built sanity guard + narrative consistency (adversarial-audit catches)
...
### Maintenance
- docs(design-audit): sync PROGRESS.md + README banner to 31 remaining (was 150)
...
### Bug Fixes
- fix(site): design-audit backlog batch 12 — geo-browse area-guide video sizing (1 item)
...
### Bug Fixes
- fix(site): design-audit backlog batch 9 — geo-browse copy/chart items (4 items)

---


## v1.751.10 (2026-07-08)

### Bug Fixes
- fix(site): design-audit backlog batch 8 — geo-browse data-accuracy items (3 items)
...
### Bug Fixes
- fix(site): design-audit backlog batch 3 — geo-browse group (8 items)
