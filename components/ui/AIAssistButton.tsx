  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className="absolute right-2 top-2 flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--gray-bg)] text-[var(--gray-secondary)] hover:bg-[var(--accent)] hover:text-[var(--brand-navy)] focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
      ...
      {open && (
        <>
          ...
          />
          <div
            className="absolute right-0 top-full z-50 mt-2 w-full min-w-[320px] max-w-[420px] rounded-xl border border-[var(--gray-border)] bg-white p-4 shadow-lg"
            role="dialog"
          ...
          >
            <div className="space-y-3">
              ...
              <select
                ...
                className="w-full rounded-[6px] border border-[var(--gray-border)] px-3 py-2 text-sm focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)]"
              >
                {ACTIONS.map((a) => (
              ...
              <button
                ...
                disabled={loading}
                className="w-full rounded-lg bg-[var(--accent)] py-2.5 font-semibold text-[var(--brand-navy)] hover:opacity-90 disabled:opacity-50"
              >
                ...
                <>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 rounded-lg bg-[var(--brand-navy)] py-2 text-sm font-semibold text-white hover:opacity-90"
                    >
                      Insert
                    </button>
                    <button
                      ...
                      disabled={loading}
                      className="flex-1 rounded-lg border border-[var(--gray-border)] py-2 text-sm font-semibold hover:bg-[var(--gray-bg)] disabled:opacity-50"
                    >
                      Regenerate
                    </button>
                  </div>
