...
/** Secondary regions for the person workspace — streamed under Suspense. */
export async function PersonWorkspaceBody(props: PersonWorkspaceIdentity) {
  ...
  /* ── §25 Mobile Contact Detail — mapping in MobileLeadDetail.
     PersonWorkspace mounts it at < md / ?view=mobile. */
  const mobileDetail = (
    <MobileLeadDetail
