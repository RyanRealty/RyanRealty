/**
 * PlaceDocuments — the recorded governing documents section, shared by every
 * place grain: subdivision, community and neighborhood. Hosted copies of the
 * CC&R declaration and its recorded amendments, each shown with the recording
 * reference that identifies it.
 *
 * One component because the honesty requirements are identical at every grain,
 * and a second copy is a second place for the R7 caveat to drift out of date.
 *
...
export function PlaceDocuments({ displayName, documents }: Props) {
