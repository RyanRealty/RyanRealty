...
const SOCIAL_LINKS: readonly { label: string; href: string; icon: V3IconName }[] = [
  ...
  { label: 'TikTok', href: BRAND.social.tiktok, icon: 'Tiktok' },
  { label: 'X', href: BRAND.social.x, icon: 'X' },
      ...
      <div className="v3-footer__inner">
        <div className="v3-footer__brand">
          ...
          <ul className="v3-footer__contact">
            <li className="v3-footer__firm">{BRAND.name}</li>
            <li>
              {/* Office address points at the Google Business Profile. */}
              <a
        ...
        <div className="v3-footer__base">
          ...
          <p className="v3-footer__line">
            © {year ? `${year} ` : ''}
            {BRAND.legalName}. Licensed in Oregon. Equal Housing Opportunity.
          </p>
          ...
          <p className="v3-footer__fine">
            ...
            deemed reliable but not guaranteed. Oregon real estate license{' '}
