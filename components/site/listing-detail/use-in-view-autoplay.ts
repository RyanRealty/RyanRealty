 ...
 *
 * Listing-register copy of the kb hook (the kb original still serves
 * KbFeatured + KbCommunities until the homepage family rolls; this copy keeps
 * the listing family self-contained so deleting components/site/kb later
 * cannot break the money page).
 */
