...
describe('design directive contracts', () => {
  ...
  it('D109 — one chart grammar for public, admin, and documents', () => {
    ...
    const cma = readSrc('lib/cma/market-charts.ts')
    ...
    // The CMA's own document charts live in lib/cma/market-charts.ts. The
    // seller document's chapters were rebuilt to
    // docs/plans/CMA_REIMAGINED_2026-09-07.md, which took the year sparkline
    // out of opinion-pages.ts; the invariant is unchanged — no second kit, and
