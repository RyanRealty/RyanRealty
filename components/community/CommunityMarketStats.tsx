...
export default function CommunityMarketStats({
  ...
  return (
    <section className="bg-[var(--brand-cream)] px-4 py-12 sm:px-6 sm:py-16" aria-labelledby="market-stats-heading">
      <div className="mx-auto max-w-7xl">
        <h2 id="market-stats-heading" className="text-2xl font-bold tracking-tight text-[var(--brand-navy)]">
          {communityName} Market Overview
        </h2>
        ...
        <div className="mt-8">
          <Link
            href={`/reports?community=${encodeURIComponent(slug)}`}
