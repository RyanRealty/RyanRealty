...
export function RegistryFilterChip({ label, onRemove }: { label: string; onRemove: () => void }) {
  return (
    <Badge variant="default" className="srch-chip inline-flex h-auto items-center gap-1 rounded-full px-2 py-1">
      {label}
  ...
  return (
    <div aria-live="polite" className={className}>
      {chips && chips.length > 0 && (
        <Card className="srch-pop max-w-full flex-row flex-wrap items-center gap-1 rounded-full px-2.5 py-1.5 shadow-none ring-0">
