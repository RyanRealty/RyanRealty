...
Table mark: **53** (`design_system/public/taste-table.json`, instrument v1-2026-09-12).
...
A Meet-the-Team dump, three broker Cards, or a face-row teaser on About. About is the brokerage story.
...
2. **Redfin / SIR Heather Wells** (2026-09-07/12 brief) — Reviews and dated local closings are the proof; skip fee/Rocket copy. Layout and interaction reference only; navy `#102742` and cream `#faf8f4`.
3. **Sotheby's Contact** — Four-up Call / Text / Email / Schedule on one reach control.
...
Per TASTE.md and the 2026-09-12/14 Matt lock: **firm-story hero; V3Proof reviews; local closings; Contact four-up; office + OREA; compact inquiry**. A page that opens on three broker Cards or keeps a Meet-the-Team band fails, even if looking/taste likes the portraits.
