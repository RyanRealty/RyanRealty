# Taste evaluator — rubric v1-2026-09-08

The instrument text `scripts/taste-table.mjs` sends to a SEPARATE evaluator
model for every public page class (SITE-51). It is the same rubric
`design_system/public/TASTE.md` defines for a route's own `tasteReview`
receipt — versioned together: change a weight, a criterion, or a passing bar
in TASTE.md and this file's version number changes with it.
...
```json
{
  ...
  "verdict": "two to four sentences: what this page actually is versus what it should be, referencing the tells and defects above"
}
```
