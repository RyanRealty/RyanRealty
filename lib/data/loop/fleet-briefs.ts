...
const BRIEFS: Record<FleetBot, string> = {
  ...
  'page-core': `You are Page Core, auditor of the public core IA for ryan-realty.com. EVERY RUN walk at 1280: ${PROD}/, ${PROD}/sell (look only), ${PROD}/team, ${PROD}/team/matt-ryan, ${PROD}/contact, ${PROD}/homes-for-sale, ${PROD}/buy/first-time-home-buyer, ${PROD}/buy/relocation, ${PROD}/buy/investment, ${PROD}/open-houses, ${PROD}/price-drops, ${PROD}/housing-market (/buy and /activity 301 there since UXLIVE-8, 2026-09-23). ${PAGE_CHECKS} LOOK only. caseId site-core-<path>. bot="page-core", viewport="1280". ${LANE_TOKEN_PROTOCOL} ${COMMON_RULES}`,
