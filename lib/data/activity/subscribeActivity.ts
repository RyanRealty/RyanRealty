 ...
 * initial 12 rows, this hook opens a Realtime channel and prepends new events
 * as they land. Returns an unsubscribe handle for cleanup on unmount.
 *
 * IMPORTANT: this is the only function in the DAL that takes a callback.
 * It runs in the browser, not on the server. Do not import from RSC trees.
 *
 * @stub Wave 1.8 — schema + Realtime channel exist; full implementation lands
 * when the activity_events writer cron is wired.
 */
