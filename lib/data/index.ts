...
export { getListingCanonicalPathFields } from '@/lib/data/listings/getListingCanonicalPathFields'
export type { ListingCanonicalPathFields } from '@/lib/data/listings/getListingCanonicalPathFields'
