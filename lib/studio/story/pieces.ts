...
export const STORY_PIECES: StoryPiece[] = [
  ...
  },
  {
    ...
    beats: {
      ...
      eat: 'tower-drinks-quiet',
      prints: 'polaroids-on-table',
      pack: 'pack-wagon-backseat-spring',
      leave: 'rearview-bachelor-dog',
      commute: 'commute-visor-sun',
      work_a: 'office-back-polaroid',
    ...
    identity: {
      from: 'photo',
      roles: ['depart', 'rearview', 'hook', 'eat', 'pack', 'leave', 'commute', 'work_a', 'return', 'home', 'look', 'call'],
      crops: { A: [0.0, 0.08, 0.56, 0.62], B: [0.44, 0.08, 1.0, 0.62] },
    },
    continuity: {
      // Round 3: one car inside and out, and one man (Matt: "this man looks different").
      hook: { from: 'rearview', keeps: 'the same station wagon interior (keep the brown vinyl dashboard, the wood-grain trim, and the seats; the road, the light, and the people are this shot\'s own)' },
      leave: { from: 'rearview', keeps: 'the same station wagon interior and the same man driving (keep the dashboard, the trim, his face, mustache, and dark wavy hair; the road and the light are this shot\'s own)' },
      commute: { from: 'call', keeps: 'the same man (keep his face, mustache, and dark wavy hair exactly; the car, the traffic, and the light are this shot\'s own)' },
      ...
      return: { from: 'depart', keeps: 'the same two-story stucco fourplex (keep its walls, windows, and front steps; the dusk, the traffic, and the people are this shot\'s own)' },
      snapshot: 'discover',
