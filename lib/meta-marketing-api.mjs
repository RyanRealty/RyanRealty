 ...
 * API version: v21.0 (bumped from v18.0 on 2026-05-29 — v18 deprecated; v21 matches
 *   lib/meta-capi.ts. Verify field requirements on any further Meta migration).
 *
...
function getConfig() {
  return {
    adAccountId: normalizeAdAccountId(requireEnv('META_AD_ACCOUNT_ID')),
