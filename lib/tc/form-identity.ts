...
export const FORM_LIBRARY: readonly FormLibraryEntry[] = [
  ...
  {
    formId: 'oref-059-delivery-addendum',
    name: 'Delivery Addendum',
    oref: '059',
    headerRegex: /OREF[-\s]*059|Delivery\s+Addendum|Receipt\s+of\s+Reports|Removal\s+of\s+Contingencies/i,
    titleRegex: /delivery\s+addendum|receipt\s+of\s+reports|removal\s+of\s+contingencies/i,
    signers: ['buyer', 'seller'],
  },
  {
    formId: 'oref-060-contingency-removal',
    name: 'Contingency Removal Addendum',
    oref: '060',
    headerRegex: /OREF[-\s]*060|Contingency\s+Removal/i,
    titleRegex: /contingency\s+removal/i,
    signers: ['buyer', 'seller'],
  },
  {
