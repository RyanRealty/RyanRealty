...
Zero hits against the banned vocab union in `marketing_brain_skills/brand-voice/VOICE.md` §6 (clichés, AI filler,
...
| Banned-vocab + FH validator | Pre-render grep | `scripts/check-banned-vocab.mjs` against `marketing_brain_skills/brand-voice/VOICE.md` §6 union |
...
| 3 | Banned vocab clean | Grep note + flyer copy against `marketing_brain_skills/brand-voice/VOICE.md` §6.  zero hits |
