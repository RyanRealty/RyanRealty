...
| 14 | Banned words clean | Grep all on-frame text + caption.md against `marketing_brain_skills/brand-voice/VOICE.md` union.  zero hits |
...
Banned-vocab grep covers (from `marketing_brain_skills/brand-voice/VOICE.md`): stunning, nestled, charming, pristine,
