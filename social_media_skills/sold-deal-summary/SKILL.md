...
| `marketing_brain_skills/brand-voice/VOICE.md` | Voice attributes, banned vocab union. Applies to BOTH the IG caption AND the LinkedIn body. |
...
| Voice grep | Banned-vocab check against `marketing_brain_skills/brand-voice/VOICE.md` §6 union | `marketing_brain_skills/brand-voice/VOICE.md` |
...
| 13 | Banned vocab clean (IG) | Grep `caption-ig.md` against `marketing_brain_skills/brand-voice/VOICE.md` §6 union.  zero hits |
| 14 | Banned vocab clean (LinkedIn) | Grep `linkedin-post.md` against `marketing_brain_skills/brand-voice/VOICE.md` §6 union.  zero hits |
...
**Capabilities used:**
- Banned-vocab grep against `marketing_brain_skills/brand-voice/VOICE.md` §6 union
