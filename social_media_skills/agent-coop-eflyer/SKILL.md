...
Hard-fail if any term from the union in `marketing_brain_skills/brand-voice/VOICE.md`
...
| 2 | Banned vocab | Grep subject, pitch, alt text, compliance line against `marketing_brain_skills/brand-voice/VOICE.md` union. Zero hits |
...
- `marketing_brain_skills/brand-voice/VOICE.md`.  voice enforcement + banned vocab union
