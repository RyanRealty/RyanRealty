...
| D38 | Place chrome may be a licensed still or reference-conditioned generation. Subject listing photos are camera/MLS. No prompt-only scenic slop. No generated people as residents. Charts in code. | creative-brain law 1 (supersedes ANTI_SLOP documentary-only) | Photo selections | deferred (target: creative-brain rejecter) | NONE | Reference pack + rejecter. | 2026-08-14 |
...
| ID | Directive | Source | Surfaces | Status | Gate | Cascade path | Opened |
|---|---|---|---|---|---|---|---|
| D41 | Em dashes (`—` U+2014) and en dashes (`–` U+2013) banned as punctuation. Exception: data placeholder in tables. | CLAUDE.md §3 + MANIFEST.md | All JSX text strings | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
| D42 | Semicolons banned in body copy. Replace with period. | CLAUDE.md §3 | All JSX text strings | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
...
| D44 | Exclamation marks in body copy banned. One max per piece (social only). Zero in market data. | CLAUDE.md §3 + MANIFEST.md | All consumer text | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |

### BRAND VOICE — BANNED WORDS

| ID | Directive | Source | Surfaces | Status | Gate | Cascade path | Opened |
|---|---|---|---|---|---|---|---|
| D45 | Banned clichés: stunning, breathtaking, gorgeous, charming, pristine, nestled, boasts, must-see, dream home, meticulously maintained, entertainer's dream, tucked away, hidden gem, truly, spacious, cozy, luxurious, updated throughout, turnkey, immaculate, captivating, exquisite. | CLAUDE.md §3 + SKILL.md "Never" | All consumer text | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
| D46 | Banned AI filler: delve, leverage, tapestry, navigate, robust, seamless, comprehensive, elevate, unlock, holistic, dynamic, vibrant, bustling, eclectic, curated, bespoke, foster. | CLAUDE.md §3 | All consumer text | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
| D47 | Banned vague qualifiers: approximately, roughly, about, around, fairly, somewhat. Use the real number instead. | CLAUDE.md §3 + MANIFEST.md | All consumer text | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
| D48 | Banned marketing slop: top producing, top 1 percent, white glove, luxury concierge, premier brokerage, exclusive (brokerage descriptor), boutique brokerage, your real estate journey, we are passionate about, we pride ourselves on. | CLAUDE.md §3 | All consumer text | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
| D49 | Banned fake urgency: act fast, don't miss out, won't last long, won't last. | CLAUDE.md §3 | All consumer text | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
| D50 | Banned hype openings: "get ready to fall in love," "you won't believe," "introducing," "stunning new listing." | CLAUDE.md §3 | Hero text, social captions | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
| D51 | Banned pandering: "what a beautiful home," "you have great taste," "don't worry, we will handle everything," "let me explain in simple terms." | CLAUDE.md §3 | All consumer text | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-13 |
...
| D58 | Unavailable stats use em-dash `—` as data placeholder. Do not use `N/A`, `null`, `0`, or `—` for decoration. | MANIFEST.md + SKILL.md | Stat cards, tables | wont-fix | NONE | Component-level convention (`<Price>`/`<TabularNumber>` return em-dash for null), not CI-gated. The mechanical em-dash ban this exception referenced (G2) was retired 2026-09-07. | 2026-05-13 |
...
| D77 | Listing detail must BEAT Zillow Showcase. VacationRentalPotential + TransparentCMASummary are the remaining Wave 3 minimums; each ships only once wired to a real source, never as a teaser. **ClimateRiskBlock RETIRED 2026-07-28 (Matt).** Its null branch shipped a fixed paragraph naming FEMA / Deschutes County WUI / NOAA sources it never queried, identical on every listing — a §0 violation, not a feature. Zillow has also dropped climate scores from listings. Do not reintroduce. | 2026-05-28 chat + EXECUTION_PLAN §8; amended 2026-07-28 | `app/listing/[listingKey]/page.tsx` + `design_system/ryan-realty/ui_kits/listing-detail/parity.json` | enforced | G6 | Both surviving components listed `blocking: true` in parity.json; G6 fails the page if an import goes missing. site-contracts D77 now asserts ClimateRiskBlock is ABSENT. | 2026-07-28 |
...
| D79 | No self-describing tone filler ("honest guidance from a local team", "trusted", "passionate"). Let a specific fact carry the line. The city hero lede leads with numbers (active count + median + days-to-pending), not a brand adjective. | 2026-05-28 chat + CLAUDE.md §3 D53 | All hero ledes + body copy | wont-fix | NONE | RETIRED 2026-09-07 (Matt): mechanical voice canon removed; VOICE.md is prose-only now, no gate. | 2026-05-28 |
...
| D88 | The boundary map (polygon + listing pins) on city, neighborhood, and community pages MUST use ONE shared DAL: `getGeoBoundaryMapData({ geoType, geoSlug })` from `@/lib/data`. Pins come from the `listings_in_boundary` PostGIS RPC (spatially correct, no per-page City/SubdivisionName string divergence). Ad-hoc multi-call patterns (getBoundaryGeoJSON + getCityListings separately, or getNeighborhoodListings with wrong filter column) are banned. | 2026-05-28 wave-3 rebuild | `app/cities/[slug]/page.tsx`, `app/cities/[slug]/[neighborhoodSlug]/page.tsx`, `app/communities/[slug]/page.tsx` | enforced | G31 | `lib/data/geo/getGeoBoundaryMapData.ts` is the lowest reusable unit. G31 (`scripts/check-boundary-map.mjs`) fails CI when a geo page renders the map block without importing the shared function. Fixes the neighborhood-pins-returning-empty bug (wrong column filter) and the community-map-missing bug (spatial RPC vs. SubdivisionName string match). | 2026-05-28 |
| D89 | Community pages MUST resolve hero + tile photos via `communityImage(slug)` from `@/lib/geo-images`. The legacy `golfCommunityImage` only covered 7/14 communities; 7 communities (broken-top, caldera-springs, northwest-crossing, black-butte-ranch, vandevert-ranch, three-rivers, sunriver) were falling back to a generic Bend photo. `communityImage` covers all 14: 1) dedicated LP photo, 2) golf-guide LP photo, 3) null so the city asset_library fills the gap correctly. | 2026-05-29 owner-review | `app/communities/[slug]/page.tsx`, `lib/geo-images.ts`, sibling-community tiles in RelatedAreas | enforced | G32 | `communityImage()` replaces `golfCommunityImage()` on the community page. G32 (`scripts/check-community-page.mjs`) fails CI if the community page doesn't import `communityImage`. | 2026-05-29 |
| D90 | Community pages MUST render an open-houses section (`<OpenHousesGrid city={cityName} daysAhead={14} />`). Without it, buyers visiting a resort community page see no upcoming open house events even when events exist in the MLS. | 2026-05-29 owner-review | `app/communities/[slug]/page.tsx` | enforced | G32 | `<OpenHousesGrid>` import + usage required by G32. Already present in the Wave 3 rebuild; gate prevents future removal. | 2026-05-29 |
| D91 | Community pages MUST render listing cards (photo, price, beds/baths/sqft, address, link) for the active homes within the boundary. The map alone is not enough — buyers need to scan the listing cards without navigating to a search page. Source: `getListingTiles({ listingKeys })` fed by boundary pin keys from `getGeoBoundaryMapData`. Cap at 24, "View all" link when there are more. | 2026-05-29 owner-review | `app/communities/[slug]/page.tsx` | enforced | G32 | `ListingCard` import + usage required by G32. | 2026-05-29 |
| D92 | Community-page boundary map MUST fit to the POLYGON bounds (not pin bounds). Resort communities can be small (Pronghorn, Caldera Springs, Crosswater); fitting to pins that happen to be spread across a large area shifts the polygon off-screen. Fix: `computeBounds(polygons)` used as the seed for `map.fitBounds(bounds, padding)` with 48px padding. A setTimeout flush handles containers that resolve size after first paint. | 2026-05-29 owner-review | `components/site/NeighborhoodMap.client.tsx` | enforced | G32 (indirectly; the map logic lives in NeighborhoodMapClient which is shared by all geo pages) | NeighborhoodMap.client.tsx `handleMapLoad` seeds the GoogleMap center from polygon centroid + calls `fitBounds` twice (immediately + setTimeout flush). | 2026-05-29 |
| D96 | EVERY resort/planned community AND Bend neighborhood with a detail page MUST be content-rich (overview prose + at-a-glance facts + amenities/drive-times), not thin. Enforced by G33 (`scripts/check-community-content.mjs`) against a shrinking coverage baseline (`data/community-content-baseline.json`): a new geo cannot ship without a `data/resort-community-[slug].json` config, and the backlog must shrink to zero. Content is RESEARCHED from primary sources (community/HOA/golf/county/news) and VERIFIED, never invented — a geo leaves the backlog only when a cited config lands. | 2026-05-29 owner-review ("use this logic for all neighborhood, resort and planned communities ... hard code the gates to ensure we get the best output") | `scripts/check-community-content.mjs`, `data/community-content-baseline.json`, `data/resort-community-*.json` | enforced | G33 | 1/27 covered at landing (tetherow); 26-geo research+author backlog tracked. Wave 1: resort/planned communities. Wave 2: Bend neighborhoods (need the /cities/[slug]/[neighborhoodSlug] page enriched + neighborhood-shaped content). | 2026-05-29 |
| D97 | The site MUST be built for AI-agent citability (GEO): every key surface emits machine-readable JSON-LD so Claude, ChatGPT, Perplexity, and Google AI Overviews surface and cite Ryan Realty for Central Oregon real estate. Site-wide Organization (RealEstateAgent + LocalBusiness, with sameAs, the 3 brokers, and NAP) + WebSite render via the layout `<JsonLd>`. City and community pages emit the entity Place + a market Dataset + a verified FAQPage, all from ONE source (`buildMarketFaq`) so visible numbers never diverge from the markup (the top cause of schema being discarded). Listing pages emit RealEstateListing + BreadcrumbList. Every figure traces to `market_pulse_live` or the community record, never invented. | 2026-05-29 owner-directive ("build this site so other ai agents will use it when asked about central oregon homes ... no exceptions") | `lib/site/json-ld.ts`, `lib/site/market-faq.ts`, `components/JsonLd.tsx`, `app/cities/[slug]/page.tsx`, `app/communities/[slug]/page.tsx`, `components/site/listing-detail/ListingDetailShell.tsx` | enforced | G34 | City + community + neighborhood + homepage + listing all wired and SSR-verified (every geo page type emits entity Place + market Dataset + verified FAQPage). robots.ts allows the full AI retrieval-crawler set. FOLLOW-UP: optional llms.txt dynamic-stats enrich (low value, only Claude + Perplexity consume it). | 2026-05-29 |
| D98 | Charts only appear where the data volume supports an honest read. The market price-trend chart (PriceChart) renders ONLY on city + region pages (100 to 180 SFR sales per month, enough for a real monthly median). It is OMITTED on community + neighborhood pages, where sale volume is 1 to 4 per month and a monthly median is statistical noise (verified 2026-05-29: sub-city geos have only the current month cached, on 1 to 4 solds). Rules for the chart that does render: completed months only (the in-progress month is dropped, since a partial period medians misleadingly), linear segments plus a dot per month (no monotone smoothing, so the real bounce shows), and a data-range y-axis (a $0 baseline flattens real 15 to 20 percent swings). Source: getPriceHistory into market_stats_cache (SFR-only, methodology-versioned), never raw listings. | 2026-05-29 owner-review ("not sure it is accurate", chose honest monthly) | components/site/PriceChart.tsx, components/site/PriceChart.client.tsx, app/cities/[slug]/page.tsx, design_system/ryan-realty/ui_kits/city/parity.json | enforced | G6 | City parity.json now requires PriceChart. The 6-complete-months runtime threshold keeps it off thin geos. FOLLOW-UP (optional): a trailing-12-month (rolling_365d) rollup would let the LARGER communities show an honest trend, a separate market_stats_cache backfill task, not done. | 2026-05-29 |
| D99 | No fabricated social proof. Testimonials, reviews, ratings, ranking or top-of-market claims, sale-volume counts, and years-in-business stats MUST trace to a verified source (a reviews table, Google Business Profile, OREA, the brokers table) or be omitted. Hardcoded or illustrative testimonials are an FTC deceptive-endorsement and Data Accuracy violation. When delegating content generation to a subagent, feed only verified facts and review the output. Never let a generator invent client quotes, broker biography, anti-automation claims, or service-level promises. The review UI (TestimonialBlock) stays in deferredComponents until a real source is wired. | 2026-05-29 owner-review (a subagent fabricated testimonials on the profile-page rebuild) | app/about/page.tsx, design_system/ryan-realty/ui_kits/about/parity.json, CLAUDE.md | deferred | review-enforced (a static linter cannot detect a fabricated name, so this is enforced by human review plus the parity-defer pattern plus feeding generators verified-facts-only) | The profile-page rebuild caught and stripped fabricated testimonials, an invented backstory, and anti-automation claims that contradict the FUB workflow. | 2026-05-29 |
| D95 | Community pages MUST carry resort-LP-level depth when verified content exists: overview prose, an at-a-glance facts card (founded, acres, architect, master HOA, recognition), drive times, and amenities. Source: `data/resort-community-[slug].json` (the SAME curated files the `/lp/[slug]` landing pages render) via the server-only `getResortCommunityContent` loader — content facts are NEVER invented; a community with no authored config simply renders fewer sections (graceful null). | 2026-05-29 owner-review ("make these community pages like the Tetherow landing page") | `app/communities/[slug]/page.tsx`, `lib/resort-community-content.ts`, `data/resort-community-tetherow.json` | enforced | G32 (community-page gate; loader returns null for unconfigured communities so the page never shows invented facts) | Tetherow fully populated. ⚠️ FOLLOW-UP: only Tetherow has an authored config — the other 13 resort communities need verified content JSONs authored before their pages reach this depth (cannot invent founded year / architect / HOA dues). Remaining LP sections not yet ported: course specs, membership tiers, builders, signature hole. | 2026-05-29 |
| D94 | A community with multiple GIS subdivision plats inside it MUST render (a) a "Subdivisions within {community}" section listing each subdivision + its active home count, and (b) those subdivisions broken out as SEPARATE polygons on the boundary map (not just the merged community outline). Source: the gated `community_subdivisions` RPC via the `getCommunitySubdivisions` DAL — spatial membership (subdivision centroid within the community polygon), NEVER an ad-hoc `boundaries` query (anon has no RLS read on `boundaries`; the RPC is SECURITY DEFINER). Map section headings drop the obvious ("homes on the map" is banned — it is self-evidently a map of homes). | 2026-05-29 owner-review | `app/communities/[slug]/page.tsx`, `lib/data/geo/getCommunitySubdivisions.ts`, `supabase/migrations/20260529050000_community_subdivisions_rpc.sql` | enforced | G32 (`scripts/check-community-page.mjs` requires the `getCommunitySubdivisions` import) | Tetherow: 22 plats broken out as map cells + listed with home counts, EACH linking to its own page at `/subdivisions/[slug]` (`app/subdivisions/[slug]/page.tsx` — boundary map + homes for sale via the same gated DAL, graceful empty state for plats with no active listings). Subdivision-map polygons are click-through too. Membership uses majority-overlap (plat is smaller than the community AND ≥50% inside its polygon) — NOT centroid-in-polygon, which over-matched oversized neighbor plats (a 1,072-acre Broken Top geometry). | 2026-05-29 |
| D93 | In-boundary listings (map pins AND homes-for-sale cards) MUST come from the precomputed `listing_boundary_xref_mv` via the `listings_in_boundary` RPC. Request-time `ST_Within` against the 589K-row `listings` table is BANNED: a wide-bbox polygon (e.g. Tetherow) makes the spatial scan ~10s cold, which blows the anon role's 3s `statement_timeout` and silently returns empty pins + empty cards while the polygon outline still renders. The spatial join runs once at MV refresh (pg_cron job `refresh_dal_mvs_15min`, ≤15 min), so request time is a sub-10ms indexed lookup. Overlapping `geo_type='neighborhood'` polygons (Bend district + resort community) each get their own xref row, which is why resort listings resolve here but NOT via `listing_tile_mv.boundary_neighborhood`. | 2026-05-29 owner-review (community cards empty) | `supabase/migrations/20260529020000_listing_boundary_xref_mv.sql`, `lib/data/geo/getGeoBoundaryMapData.ts`, `supabase/migrations/20260731140000_split_mv_refresh_jobs.sql` (pg_cron `refresh_dal_mvs_15min`) | enforced | G31 (app layer: page must import `getGeoBoundaryMapData`; DB layer documented in `docs/DATABASE_FOR_AI_AGENTS.md` §4d) | The RPC body reads the MV — verified 5/5 anon calls return 166 Tetherow pins with zero timeouts after the change (was 2/3 timeouts request-time). | 2026-05-29 |
