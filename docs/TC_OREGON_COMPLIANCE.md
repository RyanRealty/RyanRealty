...
| Every written offer or counter-offer received (listing side) | Keep a copy of **every** offer received, including ones never answered; deliver every written offer/counter to the seller promptly; give the offeror a copy if the seller rejects | — (system: `tc_offers` from the mail index, `presented_to_seller_at`, `replied_at`) | **OAR 863-015-0250(1)**: the principal broker must maintain "complete, legible, and permanent copies of all documents required by law or voluntarily generated during a real estate transaction, including all offers received by or through real estate brokers or principal brokers to the client." **OAR 863-015-0135(2)**: "A real estate licensee must promptly deliver to the offeror or offeree every written offer or counter-offer the licensee receives." (3): if the seller rejects, the licensee provides a true copy to the offeror. (4): executed copies to both parties within three banking days. Verified 2026-09-23 at [oregon.public.law/rules/oar_863-015-0250](https://oregon.public.law/rules/oar_863-015-0250) and [oar_863-015-0135](https://oregon.public.law/rules/oar_863-015-0135). The mail index records every emailed offer on our listings whether or not anyone replied, and flags "Not yet sent to seller" until an email to our seller about it exists (`docs/TC_MAIL_FILING_RULES.md`). |
