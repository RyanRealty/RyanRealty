...
**Generated:** 2026-09-24T22:51:39.090Z
...
**Exports:** `PLACE_MEMBERSHIP_STALE_HOURS`, `classifyPlaceMembershipFreshness`, `readPlaceMembershipFreshness`
...
**Tables:** `tc_mail_reviews`, `tc_mail_review_cursors`

**Selected columns:** `mailbox`, `status`, `reviewed_at`, `listed`, `started_at`, `finished_at`

---

### `lib/data/tc/mail-reads.ts`

**Exports:** `listDealMail`, `listMailQueue`, `countMailQueue`, `listDealConversations`, `getMailMessagesForAction`, `getDealScopeRow`, `getDocumentDealScope`

**Tables:** `tc_mail_messages`, `tc_deals`, `tc_deal_people`, `tc_cycles`, `crm_timeline`, `tc_documents`

**Selected columns:** `id`, `address`, `property_key`, `stage`, `person_id`, `crm_people(name)`, `listing_date`, `contract_acceptance_date`, `created_at`, `ts`, `kind`, `title`, `body`, `broker`, `payload`, `status`, `gmail_refs`, `subject`, `broker_name`, `name`, `cycle_id`, `tc_cycles(deal_id`, `tc_deals(broker_name`, `property_key))`
...
**Exports:** `findSigningRecipient`, `getSigningDeal`, `getSigningDocuments`, `getEnvelopeFieldsForSigning`, `updateSigningRecipient`, `saveSignerValues`, `voidEnvelopeOnDecline`, `logSigningEvent`
...
| `mv_refresh_state` | `PLACE_MEMBERSHIP_STALE_HOURS()`, `classifyPlaceMembershipFreshness()`, `readPlaceMembershipFreshness()` <br /> `lib/data/loop/place-membership-freshness.ts` |
...
| `place_membership` | `PLACE_MEMBERSHIP_STALE_HOURS()`, `classifyPlaceMembershipFreshness()`, `readPlaceMembershipFreshness()` <br /> `lib/data/loop/place-membership-freshness.ts` |
...
| `tc_deal_people` | `getClientIdentity()`, `hasClientDeals()`, `listClientDeals()`, `getClientDeal()`, `clientDocumentUrl()`, `getPortalSigningRecipient()`, `getDealParties()`, `inboundReferralFeePctForDeal()`, `ensureDealPartiesFromFile()`, `peopleEmailsByNames()`, `getDealsForPerson()`, `getPartyNamesByDealIds()`, `linkUniqueCycleParties()`, `addPersonToDeal()`, `removePersonFromDeal()`, `createDealWithPeople()`, `listDealMail()`, `listMailQueue()`, `countMailQueue()`, `listDealConversations()`, `getMailMessagesForAction()`, `getDealScopeRow()`, `getDocumentDealScope()`, `stageReviewAsksForRecentCloses()` <br /> `lib/data/tc/client-transactions.ts` · `lib/data/tc/deal-people.ts` · `lib/data/tc/mail-reads.ts` · `lib/data/tc/stageReviewAsksForRecentCloses.ts` |
...
| `tc_mail_messages` | `listDealAudits()`, `listDealMail()`, `listMailQueue()`, `countMailQueue()`, `listDealConversations()`, `getMailMessagesForAction()`, `getDealScopeRow()`, `getDocumentDealScope()` <br /> `lib/data/tc/deal-audit.ts` · `lib/data/tc/mail-reads.ts` |
| `tc_mail_review_cursors` | `getMailCoverage()` <br /> `lib/data/tc/mail-coverage.ts` |
| `tc_mail_reviews` | `getMailCoverage()` <br /> `lib/data/tc/mail-coverage.ts` |
