...
**Generated:** 2026-08-05T16:01:38.377Z
...
| `newsletter_subscribers` | `getAudienceCounts()`, `summarizeNewsletterEngagement()`, `getContactNewsletterDetail()`, `getBrokerNewsletterAnalytics()`, `getBrokerWarmList()` <br /> `lib/data/audiences/counts.ts` · `lib/data/crm/getContactNewsletterDetail.ts` · `lib/data/newsletter/brokerAnalytics.ts` |
