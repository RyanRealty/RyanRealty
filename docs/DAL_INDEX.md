...
**Generated:** 2026-08-19T18:58:54.823Z
...
**Selected columns:** `html_content`, `html_path`, `status`, `render_args`, `broker_slug`, `build_summary`, `id`, `person_id`, `client_email`, `client_name`, `subject_address`, `emails`, `custom`
...
**Selected columns:** `listing_key`, `photo_url`, `id`, `open_house_key`, `event_date`, `start_time`, `end_time`, `host_agent_name`, `remarks`, `rsvp_count`, `cdn_url`, `sort_order`, `caption`, `is_hero`, `ListingKey`, `agent_role`, `agent_name`, `agent_mls_id`, `agent_license`, `agent_email`, `agent_phone`, `office_name`, `office_mls_id`, `office_phone`, `OpenHouses`, `video_url`, `event`, `price`, `description`, `price_change`, `raw`, `old_status`, `new_status`, `changed_at`, `old_price`, `new_price`, `change_pct`, `OnMarketDate`, `ListPrice`, `name` (+3 more)
