...
**Generated:** 2026-09-09T18:30:43.112Z
...
**Exports:** `CMA_SFR_FILTER`, `CMA_FAILED_STATUSES`, `getCmaCityClosedOutcomes`, `getCmaCityFailedOutcomes`, `getCmaListingPriceEvents`, `getCmaCityFailedCycles`, `getCmaCityClosedSales`, `CMA_LOCAL_OUTCOME_READS`

**Tables:** `listings`, `price_history`, `listing_history`

**Selected columns:** `old_price`, `new_price`, `changed_at`, `event`, `event_date`, `price`, `description`
