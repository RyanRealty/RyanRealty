...
**Generated:** 2026-06-25T15:45:25.733Z
...
| `crm_templates` | `CRM_TEMPLATES_ADMIN_TAG()`, `tallyTemplateUsage()`, `mapTemplateRow()`, `getCrmTemplatesAdmin()` <br /> `lib/data/crm/getCrmTemplatesAdmin.ts` |
