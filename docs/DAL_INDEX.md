...
**Generated:** 2026-08-23T01:44:48.579Z
...
**Selected columns:** `geo_slug`, `value`, `sample_n`, `window_months`
...
| `analytics_mart_market_annual` | `analyzeClosedSales()`, `getCoMarketAnnual()`, `getCoMarketAnnualAt()`, `MART_FLOOR_YEAR()`, `MART_HEADLINE_YEAR()`, `assertMartFloorYear()`, `getCoMarketAnnualSeries()`, `getMartAnnualSeries()`, `getCoOfficeShareMerged()`, `getRyanBrandShare()` <br /> `lib/data/analytics/analyzeClosedSales.ts` · `lib/data/analytics/getCoMarketAnnual.ts` · `lib/data/analytics/getCoOfficeShareMerged.ts` · `lib/data/analytics/getRyanBrandShare.ts` |
...
| `market_metric` | `staleReason()`, `getMetric()`, `getCityLeaderboard()` <br /> `lib/data/market-truth/getMetric.ts` · `lib/data/market-truth/leaderboards.ts` |
