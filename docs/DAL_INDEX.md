...
**Generated:** 2026-06-13T22:20:19.217Z
...
**Cache tags:** `'trails', `trail:${slug}``

---

### `lib/data/trails/getTrailElevation.ts`

**Exports:** `computeTrailElevation`, `getTrailElevation`

---

### `lib/data/trails/getTrailGeoJSON.ts`

**Exports:** `getTrailGeoJSON`

**Cache keys:** `trail-geojson-v1`
...
### `lib/data/trails/getTrailHomes.ts`

**Exports:** `getTrailHomes`

**Tables:** `listings`

**TTL windows:** `CACHE_WINDOWS.listingTile`

**Cache tags:** `'trails', cacheTag.listings, `trail:${slug}``

---

### `lib/data/trails/getTrailsIndex.ts`

**Exports:** `getTrailsIndex`

**Cache keys:** `trails-index-v1`
...
| `listing_tile_mv` | `getOwnedHomeMatches()`, `getBendNeighborhoodLedger()`, `getListingTiles()`, `getTotalListingCount()`, `getListingTilesCount()`, `getCityListings()`, `getCommunityListings()`, `getZipListings()`, `getNeighborhoodListings()` <br /> `lib/data/crm/getOwnedHome.ts` · `lib/data/geo/getBendNeighborhoodLedger.ts` · `lib/data/listings/getListingTiles.ts` |
...
| `visitor_events` | `saveAnonymousPartialAddress()` <br /> `lib/data/leads/saveAnonymousPartialAddress.ts` |
