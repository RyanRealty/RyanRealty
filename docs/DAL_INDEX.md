...
**Generated:** 2026-07-17T14:59:00.176Z
...
**Exports:** `listOpenCmaActions`, `findOpenCmaActionBySlug`, `appendCmaActionNotify`, `getCmaActionPayload`, `updateCmaActionRow`
...
| `marketing_brain_actions` | `listOpenCmaActions()`, `findOpenCmaActionBySlug()`, `appendCmaActionNotify()`, `getCmaActionPayload()`, `updateCmaActionRow()` <br /> `lib/data/cma/queue.ts` |
