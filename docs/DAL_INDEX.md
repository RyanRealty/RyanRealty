...
**Generated:** 2026-08-26T15:09:24.591Z
...
**Exports:** `PLACE_DOCUMENTS_BUCKET`, `sortPlaceDocuments`, `recordingLabel`, `documentKindLabel`, `getPlaceDocuments`

**Tables:** `place_document_link`

**Selected columns:** `match_method`, `place_document!inner(id`, `source`, `published_name`, `doc_kind`, `recording_ref`, `recording_type`, `book`, `page`, `instrument_number`, `recording_year`, `county`, `storage_path`, `file_bytes`, `page_count)`
...
| `place_document_link` | `PLACE_DOCUMENTS_BUCKET()`, `sortPlaceDocuments()`, `recordingLabel()`, `documentKindLabel()`, `getPlaceDocuments()` <br /> `lib/data/places/getPlaceDocuments.ts` |
