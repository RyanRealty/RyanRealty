...
**Exports:** `WORK_NODE_STATES`, `assertWorkNodeDraft`, `isLegalTransition`, `assertTransition`, `fleetNodePriority`, `STALE_IN_PROGRESS_DAYS`, `SITE_CLAIM_IDLE_HOURS`, `isSiteClaim`, `isStaleInProgress`, `isCloudAgentSession`, `ORPHAN_GRACE_MIN`, `shouldAutoRelease`
