...
**Generated:** 2026-08-27T23:50:42.482Z
...
**Exports:** `isUntrackableLink`, `isLikelyBotUserAgent`, `createShortLink`, `instrumentSmsLinks`, `resolveAndLogShortLinkClick`
...
| `crm_short_links` | `isUntrackableLink()`, `isLikelyBotUserAgent()`, `createShortLink()`, `instrumentSmsLinks()`, `resolveAndLogShortLinkClick()` <br /> `lib/data/crm/shortLinks.ts` |
