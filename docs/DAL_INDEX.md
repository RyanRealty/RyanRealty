...
**Generated:** 2026-08-30T20:05:36.267Z
...
**Exports:** `foldCampaignRecipients`, `cohortEmailKeyForJob`, `getBulkEmailCampaigns`, `getBulkEmailCampaignDetail`
...
| `crm_bulk_jobs` | `foldCampaignRecipients()`, `cohortEmailKeyForJob()`, `getBulkEmailCampaigns()`, `getBulkEmailCampaignDetail()`, `inFlightEmailCohortJobs()`, `normalizeBulkJobStatus()`, `computeProgress()`, `buildBulkJobView()`, `getCrmBulkJob()`, `getRecentCrmBulkJobs()` <br /> `lib/data/crm/getBulkEmailCampaigns.ts` · `lib/data/crm/getCrmBulkJob.ts` |
