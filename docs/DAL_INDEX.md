...
**Exports:** `MAX_DRAFTS`, `HIGH_IMP`, `TITLE_META_IMP`, `RESEED_AFTER_DAYS`, `ctr`, `nextSiteNumber`, `formatSiteGap`, `normalizeQuery`, `WINNERS`, `LANDING_BUCKETS`, `winnerFor`, `diagnose`, `pathOf`, `alreadySeeded`, `kindLabel`, `toDraft`, `formatDrafts`, `cannibalsFromLandings`, `cannibalsFromQueryPages`, `dropTrackerQueries`, `buildGscGapDrafts`, `CLASS_ROUTE`, `buildClassSlipDrafts`, `seedWindow`, `pullGscSeedRows`, `readSeedContext`, `insertGscGapNodes`, `seedClassSlipNodes`
