...
**Generated:** 2026-08-13T00:59:39.116Z
...
### `lib/data/listings/getActiveBuilders.ts`

**Exports:** `getActiveBuilders`, `resolveBuilderNameFromSlug`

**Tables:** `listings`

**Selected columns:** `BuilderName:details->>BuilderName`
...
**Tables:** `tc_deals`, `tc_cycles`, `tc_checklist_items`, `tc_deal_people`
...
**Tables:** `tc_deal_people`, `tc_deals`, `tc_cycles`, `tc_events`, `crm_people`

**Selected columns:** `id`, `deal_id`, `person_id`, `role`, `name`, `property_key`, `address`, `stage`, `city`, `state`, `broker_name`, `stage_detail`, `kind`, `source`, `source_guid`, `status`
...
| `analytics_mart_market_annual` | `analyzeClosedSales()`, `getCoMarketAnnual()`, `getCoMarketAnnualSeries()`, `getCoOfficeShareMerged()`, `getRyanBrandShare()` <br /> `lib/data/analytics/analyzeClosedSales.ts` · `lib/data/analytics/getCoMarketAnnual.ts` · `lib/data/analytics/getCoOfficeShareMerged.ts` · `lib/data/analytics/getRyanBrandShare.ts` |
...
| `tc_deal_people` | `getClosingsBoard()`, `getDealParties()`, `getDealsForPerson()`, `getPartyNamesByDealIds()`, `addPersonToDeal()`, `removePersonFromDeal()`, `createDealWithPeople()` <br /> `lib/data/tc/closings.ts` · `lib/data/tc/deal-people.ts` |
| `tc_deals` | `getSyncFreshness()`, `getAlertQueueHealth()`, `getSignoffWaits()`, `getClosingsBoard()`, `getDealsForPerson()`, `createDealWithPeople()` <br /> `lib/data/oversight/health.ts` · `lib/data/tc/closings.ts` · `lib/data/tc/deal-people.ts` |
