...
**Generated:** 2026-07-17T12:54:13.009Z
...
**Exports:** `listOpenCmaActions`, `findOpenCmaActionBySlug`, `updateCmaActionRow`
...
| `marketing_brain_actions` | `listOpenCmaActions()`, `findOpenCmaActionBySlug()`, `updateCmaActionRow()` <br /> `lib/data/cma/queue.ts` |
