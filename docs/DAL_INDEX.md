...
**Generated:** 2026-09-24T05:54:45.858Z
...
**Exports:** `MEMBERSHIP_LOOKBACK_HOURS`, `MEMBERSHIP_RUN_MAX`, `planMembershipRefresh`, `leadingCandidateRun`, `refreshChangedPlaceMembership`

**Tables:** `listings`, `place_membership`

**Selected columns:** `ListingKey`, `ModificationTimestamp`, `listing_key`, `computed_at`
...
**Tables:** `tc_deals`, `tc_cycles`, `tc_documents`, `tc_offers`, `tc_principal_reviews`, `tc_mail_messages`

**Selected columns:** `id`, `property_key`, `address`, `stage`, `broker_name`, `deal_id`, `kind`, `deal_type:raw->>dealType`, `year_built:raw->property->>yearBuilt`, `cycle_id`, `name`, `archived`, `ingested_at`, `reader:classification->reader`, `buyer_name`, `status`, `submitted_at`, `presented_to_seller_at`, `replied_at`, `document_id`, `document_ids`, `reviewed_at`, `decision`
...
| `place_membership` | `PLACE_MEMBERSHIP_STALE_HOURS()`, `classifyPlaceMembershipFreshness()`, `readPlaceMembershipFreshness()`, `MEMBERSHIP_LOOKBACK_HOURS()`, `MEMBERSHIP_RUN_MAX()`, `planMembershipRefresh()`, `leadingCandidateRun()`, `refreshChangedPlaceMembership()` <br /> `lib/data/loop/place-membership-freshness.ts` · `lib/data/market-truth/refreshPlaceMembership.ts` |
