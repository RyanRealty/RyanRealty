...
**Generated:** 2026-09-24T14:06:18.064Z
...
| `tc_events` | `getClientIdentity()`, `hasClientDeals()`, `listClientDeals()`, `getClientDeal()`, `clientDocumentUrl()`, `getPortalSigningRecipient()`, `getDealParties()`, `inboundReferralFeePctForDeal()`, `ensureDealPartiesFromFile()`, `peopleEmailsByNames()`, `getDealsForPerson()`, `getPartyNamesByDealIds()`, `linkUniqueCycleParties()`, `addPersonToDeal()`, `removePersonFromDeal()`, `createDealWithPeople()`, `listDocumentReview()`, `countDocumentReview()` <br /> `lib/data/tc/client-transactions.ts` · `lib/data/tc/deal-people.ts` · `lib/data/tc/document-review.ts` |
