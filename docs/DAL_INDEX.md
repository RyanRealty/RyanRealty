...
**Selected columns:** `id`, `key`, `channel`, `name`, `subject`, `body`, `category`, `is_active`, `is_shared`, `owner_broker`, `steps`, `email_key`, `event`
