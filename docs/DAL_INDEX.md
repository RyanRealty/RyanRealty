...
**Generated:** 2026-08-05T15:48:49.026Z
...
| `tc_cycles` | `getSyncFreshness()`, `getAlertQueueHealth()`, `getSignoffWaits()`, `getClosingsBoard()` <br /> `lib/data/oversight/health.ts` · `lib/data/tc/closings.ts` |
| `tc_deals` | `getSyncFreshness()`, `getAlertQueueHealth()`, `getSignoffWaits()`, `getClosingsBoard()` <br /> `lib/data/oversight/health.ts` · `lib/data/tc/closings.ts` |
