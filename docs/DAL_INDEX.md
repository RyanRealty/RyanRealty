...
**Generated:** 2026-08-18T06:24:28.250Z
...
**Exports:** `readPublicStatSeries`, `INGEST_CHECK_BUDGET_DAYS`, `gradeStatSeries`, `getStatIngestHealth`
...
| `sync_logs` | `runLoopSentinel()`, `getLoopStatus()` <br /> `lib/data/loop/sentinel.ts` · `lib/data/loop/status.ts` |
