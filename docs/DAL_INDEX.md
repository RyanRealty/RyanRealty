...
**Generated:** 2026-09-21T05:03:12.599Z
...
### `lib/data/cities/getCityMetadata.test.ts`

**Tables:** `communities`

**Selected columns:** `slug`, `name`, `hero_image_url`
...
| `sale_pricing_facts` | `countSalePricingFacts()`, `selectPricingFactsPool()`, `selectPricingFactsNear()`, `getPricingMarketIndex()`, `getPricingSubdivisionCells()`, `getListingWaterSource()` <br /> `lib/data/pricing/facts.ts` |
