...
**Generated:** 2026-09-02T17:37:46.764Z
...
**Exports:** `TAXLOT_DISCLAIMER`, `getTaxlotsNear`, `getTaxlotsInBoundary`

**Cache keys:** `taxlots-near-v1`, `taxlots-in-boundary-v1`

**TTL windows:** `CACHE_WINDOWS.taxlots`

**Cache tags:** `'taxlots'`, `'taxlots', `${filled.geoType}:${filled.geoSlug}``
