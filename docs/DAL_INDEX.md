...
**Generated:** 2026-09-25T12:02:59.188Z
...
**Exports:** `REPORT_BUCKET`, `editionPdfPath`, `editionPdfObjectUrl`, `listPublishedEditions`, `getPublishedEdition`, `getEditionForWrite`, `uploadEditionPdf`, `upsertEdition`
...
| `market_report_editions` | `REPORT_BUCKET()`, `editionPdfPath()`, `editionPdfObjectUrl()`, `listPublishedEditions()`, `getPublishedEdition()`, `getEditionForWrite()`, `uploadEditionPdf()`, `upsertEdition()` <br /> `lib/data/market-report/editions.ts` |
