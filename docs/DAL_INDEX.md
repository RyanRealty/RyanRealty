...
**Generated:** 2026-07-14T03:00:21.941Z
...
**Exports:** `findCmaSubjectByMls`, `findCmaSubjectByAddress`, `selectCmaCompsPool`, `getCmaMarketStatsRow`, `getCmaMarketPulseRow`, `getCmaBrokerBySlugOrEmail`, `listActiveBrokersForCma`
...
**Exports:** `createShortLink`, `instrumentSmsLinks`, `resolveAndLogShortLinkClick`
...
| `crm_short_links` | `createShortLink()`, `instrumentSmsLinks()`, `resolveAndLogShortLinkClick()` <br /> `lib/data/crm/shortLinks.ts` |
