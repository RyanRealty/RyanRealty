...
**Generated:** 2026-08-10T20:12:27.261Z
...
**Tables:** `analytics_mart_feature_annual`, `listings`

**Selected columns:** `feature_key`, `sold_count`, `total_volume`, `median_close`, `mean_close`, `market_sold_count`, `market_volume`, `unit_share_pct`, `volume_share_pct`, `methodology`, `computed_at`, `ClosePrice`, `fireplace_yn`, `fireplaces_total`, `garage_yn`, `association_yn`
...
**Exports:** `getCoMarketAnnual`, `getCoMarketAnnualSeries`

**Tables:** `analytics_mart_market_annual`, `listings`

**Selected columns:** `year`, `type_scope`, `sold_count`, `total_volume`, `median_close`, `mean_close`, `property_type_breakdown`, `methodology`, `computed_at`, `ClosePrice`, `PropertyType`
