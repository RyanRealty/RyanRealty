...
**Generated:** 2026-08-15T14:14:46.709Z
...
**Exports:** `COMPANY_IMPROVEMENT_DOMAINS`, `isCompanyImprovementDomain`, `assertCompanyDomain`, `confidenceFromVerdicts`, `scoreCandidate`

---

### `lib/data/loop/ledger-draft.ts`

**Exports:** `assertLedgerDraft`

---

### `lib/data/loop/ledger.ts`

**Exports:** `insertImprovementLedgerRow`, `listOpenImprovementWindows`, `getChangeClassConfidence`
...
**Tables:** `crm_people`, `marketing_brain_actions`, `sync_state`, `tc_commissions`, `site_improvement_ledger`, `newsletter_subscribers`, `brokers`, `market_pulse_live`, `target_query_benchmark`, `crm_sequences`, `tc_deals`, `skyslope_transactions`, `tc_form_catalog_items`

**Selected columns:** `stage`, `id`, `status`, `last_delta_sync_at`, `last_full_sync_at`, `gci`, `domain`, `actual_delta`, `methodology_version`, `query`, `synced_at`, `expires_at`, `updated_at`
...
| `site_improvement_ledger` | `insertImprovementLedgerRow()`, `listOpenImprovementWindows()`, `getChangeClassConfidence()`, `collectCompanyScoreboardSignals()` <br /> `lib/data/loop/ledger.ts` · `lib/data/loop/signals.ts` |
