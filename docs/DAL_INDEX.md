...
**Generated:** 2026-07-31T17:08:06.466Z
...
**Exports:** `arrayLiteral`, `ilikeExact`, `BOOLEAN_PREDICATES`, `BOOLEAN_FILTER_KEYS`, `MULTI_FIELD_DEFS`, `LEGACY_PROPERTY_SUB_TYPE_MAP`, `resolveLegacyPropertySubType`, `TEXT_FIELD_COLUMNS`, `RANGE_FIELD_COLUMNS`
...
| `search_facet_counts` | `getSearchFacetCounts()` <br /> `lib/data/listings/searchFacets.ts` |
