...
**Generated:** 2026-09-25T12:35:58.340Z
...
**Exports:** `getListingsForReconcile`, `getClosedListingKeysInWindow`, `rebuildPlaceMembershipForKeys`, `recordAbsentFromMls`, `getAbsentFromMlsKeys`, `clearAbsentFromMls`

**Tables:** `listings`, `market_listing_absent_from_mls`

**Selected columns:** `ListingKey`, `listing_key`
...
| `market_listing_absent_from_mls` | `getListingsForReconcile()`, `getClosedListingKeysInWindow()`, `rebuildPlaceMembershipForKeys()`, `recordAbsentFromMls()`, `getAbsentFromMlsKeys()`, `clearAbsentFromMls()` <br /> `lib/data/sync/closingsReconcile.ts` |
