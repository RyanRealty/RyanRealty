...
**Generated:** 2026-08-02T22:45:23.812Z
...
| `crm_broker_alerts` | `searchLegalCorpus()`, `latestCorpusVersion()`, `corpusCounts()`, `flagLawQuestionToMatt()`, `listPendingAlerts()`, `claimAlert()`, `markSent()`, `markFailure()`, `refuseAlert()`, `reclaimStaleSending()`, `recentHealthAlertExists()`, `insertHealthAlert()` <br /> `lib/data/agent/legal.ts` · `lib/data/crm/brokerAlertDrain.ts` · `lib/data/crm/healthAlertQueue.ts` |
