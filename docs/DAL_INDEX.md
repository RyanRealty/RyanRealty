...
**Generated:** 2026-06-02T23:26:12.119Z
...
| `asset_library` | `getGeoTileImages()`, `getSurfaceImages()`, `pickSurfaceImage()`, `getSurfaceImage()` <br /> `lib/data/media/getGeoTileImages.ts` · `lib/data/media/getSurfaceImages.ts` |
