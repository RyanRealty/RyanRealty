...
| 2 | `app/page.tsx` (homepage) | **LOCKED v7 CINEMATIC** (Matt 2026-06-13 — Linear rejected, cinematic chosen) | Mockup at `ui_kits/homepage-v6/`. Production still HomepageHeroV3 until finished-draft approval. See Family 2 LOCKED block. |
