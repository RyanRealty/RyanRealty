...
| **Follow Up Boss** (decommissioned 2026-06-24) | `docs/archive/fub-era/README.md` | in-house CRM: `lib/crm/*`, `/admin/crm` | Do not build against FUB. Live leads write to `crm_people` via `lib/followupboss.ts` `sendEvent()` | (FUB API keys retired) |
