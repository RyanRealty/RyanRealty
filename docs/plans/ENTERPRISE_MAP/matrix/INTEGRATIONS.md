...
| INT-007 | Meta | `META_APP_ID`, `META_APP_SECRET`, `META_CAPI_ACCESS_TOKEN`, `META_PAGE_ACCESS_TOKEN`, `META_USER_ACCESS_TOKEN*`, `META_AD_ACCOUNT_ID`, `META_FB_PAGE_ID`, `META_FB_PAGE_NAME`, `META_IG_BUSINESS_ACCOUNT_ID`, `META_WEBHOOK_VERIFY_TOKEN`, `META_OAUTH_STATE`, `NEXT_PUBLIC_META_PIXEL_ID` | `lib/meta-*.ts`, `lib/meta/**`, CAPI, webhooks, ads | `meta_audience_log` last LIVE **2026-08-16T09:01:26Z** CRM `120246504502300698` received **13980** (probe 2026-08-16), on a **55 consecutive UTC day** streak. Daily freshness still watched at 36h by `evalAudienceSync`. | **Runtime** ads/social | **green** (ops) | **KEEP** 2026-08-17 | Seller growth / ads loop — list refresh is live; **spend remains Matt-gated**. Flipped to KEEP when Matt parked G11 (2026-08-17): the 2026-08-22 calendar date was the only unmet condition and the streak was already 8× the required length. |
...
| INT-007 | meta_audience LIVE 2026-08-16T09:01Z (CRM 13980); 55-day streak, hold retired 2026-08-17 | page tokens opaque | yes Runtime | KEEP | Ads |
