...
| G23 | Email residue kill: stop FUB/Beacon archived nurture sends via connected Gmail; purge FUB vocabulary and dead keys. **Partial 2026-08-18:** analytics no longer sends `fub_person_id` / advertises `fub_cid`. Residual is Gmail/Beacon send paths + CRM column names. | REQUIREMENTS R-147 | nurture |
