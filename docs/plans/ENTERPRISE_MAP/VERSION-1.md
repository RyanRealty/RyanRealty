...
| G32 | **DONE 2026-08-17** — xAI-only generate chokepoint: `lib/grok-image.ts` + `lib/grok-video.ts` + `lib/grok-voice.ts` + `lib/grok-text.ts` (`grok-4.6`). Cancel list `xai-stack-accept.json` (fal + Synthesia cancel-now; ElevenLabs VO / Replicate / OpenAI / Anthropic cancel-after-cutover). New generate paths refuse ElevenLabs / Replicate / fal / Synthesia / OpenAI images (`ci:xai-stack` + G36). Twilio STT uses grok-voice. No public post. | REQUIREMENTS R-213; D10 | social-presence |
