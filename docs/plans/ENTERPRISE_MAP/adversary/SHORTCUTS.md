...
| S-015 | Hosted ClosePrice migration apply | HIGH | **RESOLVED 2026-09-25** — confirmed live it had never actually applied (matches this row's original suspicion), then applied it via `20260925030000_report_core_defect_fixes.sql`; verified live. |
