...
| CAP-017 | Video rebuild is xAI-only. G32 chokepoint + cancel list shipped. R-045 stays LOCKED. Cutover remains: ElevenLabs VO, Replicate, OpenAI, Anthropic | ACTIVE (cutover) |
