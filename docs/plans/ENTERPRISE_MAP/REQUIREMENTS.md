...
| R-024 | Same-labeled figures on one page share one SFR source; label type_scope SFR vs all | DESIGN_DIRECTIVES; SALES_INTELLIGENCE | LOCKED | Hub/region/annual-review name omitted pulse cities + TIGER remainder (fleet 5439b87e, 2026-08-16). Gate `ci:pulse-city-remainder` |
