...
| R-002 | Months of supply = active/(closed_6mo/6); verdict pill must match thresholds ≤4/4–6/≥6 | CLAUDE.md §0; SITE_SPEC | LOCKED | gate `ci:market-formula`. Pulse MOS withholds when the row's numerator is not the count on screen, or implied six-month closes exceed a printed 12-month sold count (fleet 5d55abbd72a67d25a5d7232b46fd2fb0, 2026-08-16). Gate `ci:publish-months-of-supply`. Blog current-MOS lists rewrite through `publishBlogCurrentMos` + pulse (fleet f3693aef8c4a8198e806a1b1b2d0b723, 2026-08-17). Historical June snapshots stay labeled as June. Blog prose that classifies a MOS figure must use `marketVerdict` so 5.4 cannot be middle and buyer's in the same paragraph (fleet f865ead5d3569de3da1b49d9d5fff190, 2026-08-17). Gate `ci:publish-blog-mos-verdicts`. |
...
| R-123 | Zero-inventory city×preset pages noindex + out of sitemap; plats ≥10 lifetime sales indexable (2026-09-23, Matt plat-family directive + SEO-7: a multi-phase plat family's main page is indexable when its phases together clear 10, and a plat whose slug names a city, neighborhood or community is not; lib/data/subdivisions/subdivision-index.ts; the family grouping itself is docs/plans/PUBLIC_PRODUCT/PLACE_PAGES.md "Subdivision families"); out-of-area ≥5 active, TOP_N=100 | DECISIONS-RECORDED | VERIFIED | gate `ci:plat-families` + lib/market/plat-family.lock.test.ts (families, 2026-09-23) |
