...
| T-025 | `docs/plans/EMAIL_SEND_AUDIT_2026-07-02.md` | Diagnose “archived” emails: FUB smart campaigns via Gmail OAuth, not native CRM. | Diagnosis complete; stop was Matt revoke FUB Google access / disable the FUB smart-campaign feature. | **DONE** (diagnosis) / ARCHIVE | Smoking-gun section |
...
| T-036 | `docs/plans/WESTSIDE_BACKLOG.md` | Ranked west-side lead/share backlog from live market + funnel data. | G7 2026-08-16: every row dispositioned. Review-ask + luxury links shipped. Crawl/depth residual on G22. Paid/expired Matt-gated. | **ACTIVE** | Ranked backlog table |
