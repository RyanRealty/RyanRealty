...
| Requirements coverage | **213 directives dispositioned**: 93 LOCKED · 53 VERIFIED · 41 PARTIAL · 20 MISSING (all gap-covered) · 5 GATED · 1 PARKED. R-213 added (G32 xAI-only gen stack). Count SoR is G57. | `ENTERPRISE_MAP/REQUIREMENTS.md` + G57 (Max-pinned) |
...
| Meta audience heartbeat | last LIVE **2026-08-16T09:01:26Z** CRM received 13980, 55 consecutive UTC days. INT-007 **KEEP** 2026-08-17 (G11 parked — Matt: stop checking Meta). Daily freshness still 36h. | `evalAudienceSync` / `meta_audience_log.ran_at` |
...
| Meta audience last run | **2026-08-16T09:01:26Z** · hold retired 2026-08-17, INT-007 KEEP | `meta_audience_log.ran_at` |
