...
| Field | Value |
|--------|--------|
| **Surface** | **Claude Code (Opus 4.8, 2026-05-29)** — Ryan Realty website rebuild · Wave 3. SHIPPED this session: the **AI-agent citability (GEO) layer is COMPLETE across every page type** (city, community, neighborhood, listing, homepage) — machine-readable JSON-LD so Claude/ChatGPT/Perplexity/Google AI Overviews surface + cite Ryan Realty. Enforced by G34. Next: remaining Wave 3 route rebuilds (zip/search/sell/about/team). |
