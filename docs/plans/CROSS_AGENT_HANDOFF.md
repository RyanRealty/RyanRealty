...
Surface: Cursor cloud, branch `cursor/site-128-bend-375-ring-bf7c` off `origin/main` `072448d40` (#5 Mini-landed). PR only — Cos Mini lands. Do not merge. HOLD owner email. SITE-128 claim stays public-look.
