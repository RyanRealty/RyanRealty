...
- **Production deploy of main is RED at 6ef8d5a3f** (`dpl_3WyK3WPTynKaXhxDnMLvTNPSSbLJ`): `Error: ENOENT: no such file or directory, lstat '/vercel/path0/out/proof'` at "Traced Next.js server files". Live site still on 151a32f95 (`dpl_2fpHnspGnJfCcxTL25V6ogNHBR2d`). Being root-caused on this branch.
