...
| 2c | **Smart required-document anticipation** — `docs/TC_OREGON_COMPLIANCE.md` (cited matrix) + `lib/tc/required-documents.ts` (engine) + "Documents anticipated" on the deal page (role×property → needed/present/missing) | Shipped 2026-06-10 |
