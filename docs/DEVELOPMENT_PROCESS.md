...
| `seo-voice/` | **live** — top-site public foundation (goal system, Layer A/B + IA matrix, data foundation, dual-source measurement, bottlenecks, endtoend mission). Every file within is covered by this row. |
