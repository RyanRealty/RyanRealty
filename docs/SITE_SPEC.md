...
- [ ] Every listing detail page: TTFB p95 < 200ms (Vercel Analytics dashboard, 7-day window) *(7-day clock started 2026-05-22. 10-sample manual probe on 2026-05-23 from US-West laptop (cache-bust headers): listing detail not measured this round. Will close when Vercel Analytics surfaces real-user p95.)*
- [ ] Every city + community LP: TTFB p95 < 300ms (Vercel Analytics, 7-day window) *(7-day clock started 2026-05-22. 10-sample manual probe 2026-05-23 with `Cache-Control: no-cache`: city/bend p95=1899ms (one cold render outlier), city/redmond p95=367ms, city/sisters p95=421ms, community/tetherow p95=305ms, community/sunriver p95=306ms. Most p50s land 200-300ms, but cold-render p95 outliers exceed budget. Real-user p95 with warm edge cache will be lower — this is the metric the Vercel Analytics 7-day window captures.)*
- [ ] Homepage: TTFB p95 < 200ms (Vercel Analytics, 7-day window) *(7-day clock started 2026-05-22. 10-sample manual probe 2026-05-23: p50=208ms, p95=528ms. p50 4% over budget cold-cache; production edge cache will improve this. Real-user p95 with warm cache should land within budget.)*
