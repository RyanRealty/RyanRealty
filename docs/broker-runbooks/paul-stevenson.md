# Paul Stevenson, FUB workflow runbook
...
1. A lead clicks an ad or social bio link with your attribution (URL slug `paul-stevenson` or `paul`)
...
```
ryan-realty.com/?agent=paul-stevenson
```

Or short form:

```
ryan-realty.com/?agent=paul
```
