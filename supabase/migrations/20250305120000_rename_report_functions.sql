...
AS $$
  SELECT report_period_metrics_core(p_city, p_period_start, p_period_end, p_as_of);
$$;
...
SET search_path = public
AS $$
  SELECT report_price_bands_core(p_city, p_period_start, p_period_end, p_sales_12mo);
$$;
