...
values
  ...
  ('inn-of-the-7th-mountain', 'Inn of the 7th Mountain', 8,  false),
  ('la-pine',              'La Pine',            9,  false),
  ('mountain-high',        'Mountain High',      10, false),
  ('mt-bachelor-village',  'Mt Bachelor Village', 11, false),
  ('northwest-crossing',   'NorthWest Crossing', 12, false),
  ('pronghorn',            'Pronghorn',          13, false),
  ('redmond',              'Redmond',            14, false),
  ('rivers-edge',          'Rivers Edge',        15, false),
  ('sisters',              'Sisters',            16, false),
  ('sunriver',             'Sunriver',           17, false),
  ('terrebonne',           'Terrebonne',         18, false),
  ('tetherow',             'Tetherow',           19, false),
  ('three-rivers',         'Three Rivers',       20, false),
  ('tumalo',               'Tumalo',             21, false),
  ('vandevert-ranch',      'Vandevert Ranch',    22, false),
  ('widgi-creek',          'Widgi Creek',        23, false)
