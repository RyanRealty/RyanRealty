/**
 * Complete the Awbrey Butte 52/63/62/23 four-count fleet finding.
 *
 *   npx tsx scripts/loop-complete-awbrey-four-counts.ts <evidence>
 */
...
async function main() {
  ...
  if (!evidence) {
    console.error('usage: npx tsx scripts/loop-complete-awbrey-four-counts.ts <evidence>')
    process.exit(2)
  }
