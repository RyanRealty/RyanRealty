...
const SEEDS: readonly Seed[] = [
  ...
  },
  {
    ...
    blockedReason:
      'Matt: do off-market listing URLs (Closed, Expired, Canceled, Withdrawn) stay indexed as similar-homes landings per MASTER_SPEC:1942, or go noindex per data-architecture-plan:1095? They earn 24-42% of all organic clicks today. And should Closed detail pages showing ClosePrice be treated as a VOW-only sold surface under ODS A.4 (G54)?',
  },
  {
    versionGap: 'SITE-33',
    domain: 'public-ux',
    ...
    blockedReason:
      "Matt: 4,190 of 7,506 listing URLs in the sitemap are Southern Oregon (Medford, Klamath Falls, Grants Pass, Ashland). The referral tier you widened on 2026-07-22 gives those CITIES an honest page and a noindex rule; the LISTINGS under them render exactly like Bend homes. Should per-listing pages outside Central Oregon carry the honesty block and go noindex (follow), stay as they are, or be dropped from the sitemap while still serving? And should /oregon/[city] (55 pages, 1 click in 90 days) stay indexed?",
  },
]
