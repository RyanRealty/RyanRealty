/**
 * Complete the Tetherow counted-set list node with environment evidence.
 *
 *   npx tsx scripts/loop-complete-tetherow-count.ts
 */
...
const OWNER = 'cursor-grok-tetherow-count-20260816'
const NODE_ID = 'bff867b9-7759-41b0-9513-0747f14a417f'
...
async function main() {
  ...
  if (!evidence) {
    console.error('usage: npx tsx scripts/loop-complete-tetherow-count.ts <evidence>')
    process.exit(2)
  }
