/**
 * Complete the Tetherow regional-median fleet node with environment evidence.
 *
 *   npx tsx scripts/loop-complete-tetherow-regional-median.ts <evidence>
 */
...
const OWNER = 'cursor-grok-tetherow-regional-median-20260816'
const NODE_ID = '6cc544ec-4d32-4cf8-8f9e-5e46de2aeab7'
...
async function main() {
  ...
  if (!evidence) {
    console.error('usage: npx tsx scripts/loop-complete-tetherow-regional-median.ts <evidence>')
    process.exit(2)
  }
