/**
 * Claim the Tetherow hero-count vs visible-listing-URL fleet finding.
 *
 *   npx tsx scripts/loop-claim-tetherow-count.ts
 */
...
const MARKER = 'a1851580b1a27e12bab6a25f91a72cb9'
