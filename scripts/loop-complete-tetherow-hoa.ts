/**
 * Complete the Tetherow glance-vs-FAQ HOA node with environment evidence.
 *
 *   npx tsx scripts/loop-complete-tetherow-hoa.ts <evidence>
 */
...
const OWNER = 'cursor-grok-tetherow-hoa-20260816'
const NODE_ID = 'b25bf5f4-69f8-4b5f-a360-9f7b680dd694'
...
async function main() {
  ...
  if (!evidence) {
    console.error('usage: npx tsx scripts/loop-complete-tetherow-hoa.ts <evidence>')
    process.exit(2)
  }
