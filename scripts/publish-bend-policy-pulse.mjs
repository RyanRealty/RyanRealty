...
const PARTS = [
  ...
  },
  {
    ...
    youtubeDesc: `Bend Policy Pulse — Part 2 of 3: What People Are Arguing\n\nClips from public Bend council and advisory discussions. Narration is AI generated (ElevenLabs).\n\nWatch part 1 first for the proposal sketch. Part 3 for hearings.\n\n#shorts #BendOregon #CityCouncil #LocalNews`,
  ...
  },
  {
    ...
    youtubeDesc: `Bend Policy Pulse — Part 3 of 3: What Happens Next (key dates)\n\nNarration is AI generated (ElevenLabs). Verify hearing times on the official Bend City Council agenda before you go.\n\n#shorts #BendOregon #CityCouncil #LocalNews`,
...
function buildPayload(part) {
  ...
  return {
    ...
    hashtagsPerPlatform: {
      ...
      tiktok: ['#BendOregon', '#CityCouncil', '#LocalNews'],
      youtube: [],
      linkedin: [],
      x: ['#BendOregon'],
      google_business_profile: [],
      pinterest: ['Bend Oregon', 'city council', 'Central Oregon', 'housing policy', 'climate'],
      threads: [],
      nextdoor: [],
    },
    metadata: {
      ...
      youtube: {
        ...
        tags: ['bend oregon', 'city council', 'local news', 'housing', 'central oregon', 'shorts'],
