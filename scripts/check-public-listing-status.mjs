 ...
 */
const DELEGATED_RE =
  /COMING_SOON_STATUS|isComingSoonStatus|isPubliclyDisplayableStatus|PUBLIC_ACTIVE_STATUSES|PUBLIC_PENDING_STATUSES|PUBLIC_ON_MARKET_STATUSES|PUBLIC_ACTIVE_OR_PREDICATE|PUBLIC_ON_MARKET_OR_PREDICATE|PUBLIC_SEARCH_STATUS_FILTERS/
