...
await check('/admin/crm/9253',
  ['Lanny Olivieri', 'photo@eugenemagazine.com', '(541) 968-5110'],
  [],
  'out/admin-mobile/fix-lanny-email-9253.png')
await check('/admin/crm/5694',
  ['Steve Olivieri', '(541) 968-5228'],
  [],
  'out/admin-mobile/fix-steve-5694.png')
await check('/admin/crm/13014',
  ['Maria Hoffman', '(619) 890-2245', 'mariahoffman1@aol.com', 'Unknown number on file history'],
  [],
  'out/admin-mobile/fix-maria-13014.png')
await browser.close()
