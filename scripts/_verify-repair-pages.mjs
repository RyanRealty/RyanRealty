...
await check('/admin/crm/13014',
  ['Maria Hoffman', '(619) 890-2245', 'mariahoffman1@aol.com', 'Christopher Hoffman', 'Spouse'],
  ['Kevin Hoffman'],
  'out/admin-mobile/repair-maria-13014.png')
await check('/admin/crm/52284',
  ['Christopher Hoffman', '(619) 890-6959', 'cch1225@aol.com', 'Maria Hoffman', 'Spouse'],
  [],
  'out/admin-mobile/repair-chris-52284.png')
await check('/admin/crm/5694',
  ['Steve Olivieri', '(541) 968-5228', 'Lanny Olivieri', 'Spouse'],
  [],
  'out/admin-mobile/repair-steve-5694.png')
await check('/admin/crm/9253',
  ['Lanny Olivieri', '(541) 968-5110', 'Steve Olivieri', 'Spouse'],
  [],
  'out/admin-mobile/repair-lanny-9253.png')
await browser.close()
