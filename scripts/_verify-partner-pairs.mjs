...
await check('/admin/crm/5736',
  ['Ryan Westendorf', 'Tess McFeley', 'Partner'], [], 'out/admin-mobile/partner-5736.png')
await check('/admin/crm/52287',
  ['Tess McFeley', 'Ryan Westendorf', 'Partner'], [], 'out/admin-mobile/partner-52287.png')
await check('/admin/crm/5745',
  ['Jessica King', 'Evan Karp', 'Partner'], [], 'out/admin-mobile/partner-5745.png')
await check('/admin/crm/52294',
  ['Evan Karp', 'Jessica King', 'Partner'], [], 'out/admin-mobile/partner-52294.png')
await check('/admin/crm/5749',
  ['Kelly Plunkett', 'Devin Pohl', 'Partner'], [], 'out/admin-mobile/partner-5749.png')
await check('/admin/crm/52297',
  ['Devin Pohl', 'Kelly Plunkett', 'Partner'], [], 'out/admin-mobile/partner-52297.png')
await browser.close()
