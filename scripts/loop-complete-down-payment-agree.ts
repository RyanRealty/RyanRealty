/**
 * Complete the listing down-payment-agree fleet node with environment evidence.
 *
 *   npx tsx scripts/loop-complete-down-payment-agree.ts <evidence>
 */
...
const OWNER = 'cursor-grok-down-payment-agree-20260816'
const NODE_ID = 'ee37b3a4-cd7e-451b-8032-4ee0de37e479'
...
async function main() {
  ...
  if (!evidence) {
    console.error('usage: npx tsx scripts/loop-complete-down-payment-agree.ts <evidence>')
    process.exit(2)
  }
