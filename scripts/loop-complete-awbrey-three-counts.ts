/**
 * Complete the Awbrey Butte 52/63/62 three-count fleet finding.
 *
 *   npx tsx scripts/loop-complete-awbrey-three-counts.ts <evidence>
 */
...
const OWNER = 'cursor-loop-sentinel-2026-08-16t23-10-7e09'
const COLLIDING_OWNER = 'cursor-loop-chain-2026-08-16t23-10-c1cd'
const NODE_ID = '5688e089-6c91-451d-9b90-5e1ecb598f39'
const FLEET = 'c2764a13014ffde27bb0758f43bdb546'

async function main() {
  const evidence = process.argv.slice(2).join(' ').trim()
  if (!evidence) {
    console.error('usage: npx tsx scripts/loop-complete-awbrey-three-counts.ts <evidence>')
    process.exit(2)
  }
