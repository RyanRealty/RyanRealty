...
const SCAN_DIRS = [
  ...
  // Messages fold FINAL (2026-09-01): the crm/inbox tree is deleted. Its one
  // survivor, AddPersonForm, moved to /admin/messages and speaks v2 already.
  ...
  'app/admin/(protected)/sign-off/terms',
  ...
  'components/admin/crm/TextDraftTools.tsx',
