...
async function main() {
  ...
  const question = [
    ...
    'Then list the named defects behind the number: each one names the section (a css class or an id you can see), the severity (blocking | taste | craft), a finding of at least ten characters, and replaceWith (a house form string or null).',
    'Empty defects is only allowed above 95.',
    'Answer as JSON: {"scores":[n,n,n],"score":<median>,"perCriterion":{"design":n,"originality":n,"interaction":n,"craft":n,"honesty":n},"beats":"<the competing page you would compare this to and the metric we win or lose>","defects":[{"section":"...","severity":"...","finding":"...","replaceWith":"hero figure"|null}],"verdict":"<two sentences>"}',
  ]
    .filter(Boolean)
    .join('\n')
