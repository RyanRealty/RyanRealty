...
async function main() {
  ...
  const question = [
    ...
    'Honesty is not a trade. A prettier fold that hides a sourced figure, drops JSON-LD, removes an ask, or makes a number unverifiable is a blocking defect. UI/UX may rise; honestyFunction must hold or improve.',
