 ...
 *
 * PUBLISHED 2026-09-09T16:00:00Z. They were seeded as drafts on 2026-09-09 and shown to Matt;
 * he read them and said GO the same morning (recorded on the SITE-31 node), so all eleven now
 * carry status 'published' with that one flip timestamp.
