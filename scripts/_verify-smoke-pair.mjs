...
await check('/admin/crm/5689',
  ['Kim Anderson', 'kim.anderson@orst.edu', '(541) 760-5726', 'Brian Smith', 'Spouse'],
  [],
  'out/admin-mobile/split-kim-5689.png')
await check('/admin/crm/52285',
  ['Brian Smith', 'brian.smith@oregonstate.edu', '(541) 740-7204', 'Kim Anderson', 'Spouse'],
  [],
  'out/admin-mobile/split-brian-52285.png')
await browser.close()
