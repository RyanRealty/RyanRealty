...
if (
  ...
  commitRef === 'cursor/community-restyle-0404' ||
  commitRef === 'cursor/subdivision-restyle-3f5a' ||
  commitRef === 'cursor/market-restyle-937c' ||
  commitRef === 'cursor/about-restyle-c949'
) {
