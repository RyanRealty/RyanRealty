...
export const GOLF_ARCHITECTS: GolfArchitect[] = [
  ...
  },
  {
    ...
    name: 'John Fought',
    monogram: 'JF',
    bio: '1977 US Amateur champion. His 2012 rework of Glaze Meadow is the reason it sits in the destination eight.',
  ...
  },
  {
    ...
    monogram: 'H&J',
    bio: 'Tour-pro-and-coach pairing. Jacobsen brings the player\'s eye for shot variety. Hardy brings the architectural rigor. Brasada Canyons is their mountain-desert collaboration.',
