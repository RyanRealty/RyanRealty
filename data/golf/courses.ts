...
export const GOLF_COURSES: GolfCourse[] = [
  ...
  },
  {
    ...
    yearOpened: 1991,
    access: 'public',
    signature: 'Panoramic Cascade views. Among the lowest green fees in Central Oregon.',
    lat: 43.6675,
    lng: -121.4831,
  },
  {
  ...
  },
  {
    ...
    access: 'private',
    signature:
      'Private. 7,007 yards, par 72, updated by David McLay Kidd. Practice center includes Central Oregon\'s only 5-hole par-3 learning course.',
    lat: 44.0871,
    lng: -121.3306,
