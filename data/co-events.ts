...
export const CO_EVENTS: CoEvent[] = [
  ...
  },
  {
    ...
    lat: 44.0588,
    lng: -121.3186,
    recurrence: 'Ended after the 2026 finale. No future date is published.',
    nextConfirmedDate: null,
    endDate: null,
    priceInfo: 'Ticketed',
    ...
    blurb:
      'A barrel aged beer, cider, and whiskey festival on the Deschutes Historical Museum lawn. 2026 was the final year. No next date is published.',
  },
  {
  ...
  },
  {
    ...
    lastVerified: '2026-08-31',
    blurb:
      'A two day airshow at the Madras airport, with vintage aircraft, aerobatics, and a Friday night show, now in its third decade. 2026 was August 28–29. The next confirmed date is not published.',
  },
  {
