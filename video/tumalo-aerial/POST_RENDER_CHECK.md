...
```bash
python3 scripts/check_first_frame.py video/tumalo-aerial/out/<render>.mp4
```
...
```bash
cd /Users/matthewryan/RyanRealty/video/tumalo-aerial
npx remotion render src/index.ts <EarthZoomTumalo|FlyoverTumalo> out/<slug>.mp4 \
...
```bash
python3 scripts/check_first_frame.py video/tumalo-aerial/out/<slug>.mp4
```
