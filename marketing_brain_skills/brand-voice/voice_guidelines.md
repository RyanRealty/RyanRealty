...
## Smallness positioning — banned (Matt directive 2026-06-10)

Never position the brokerage on its size: "three brokers", "small brokerage", "small team", "a small business like ours", "team of three", "boutique". Headcount is not a position and contradicts the growth intent. Position on capability: the marketing standard every listing gets, live market data, and the direct-broker model (the broker who prices your home is the one who closes it — a service-model fact, not a size claim). Exception: "a small business like ours" stays available in Matt's personal 1:1 correspondence (review replies, personal letters) where it is his authentic voice. Mechanical enforcement: scripts/brand-voice-vocabulary.cjs category "smallness positioning".
