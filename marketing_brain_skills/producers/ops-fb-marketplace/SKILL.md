...
- `lib/crm/send-event.ts`.  When a Marketplace inquiry lands in Matt's FB Messenger, the Messenger-to-CRM forwarding integration creates a lead via this producer.
