...
| site-page-create | `marketing_brain_skills/producers/site-page-create/` | `site:page_create`, `site:landing_page_create` | matt-review-PR | REFUSE for landings. SITE_PAGES.md is the keep/cut list. Do not invent `/lp/*`. |
...
| site-property-landing | `marketing_brain_skills/producers/site-property-landing/` | `site:property_landing_create`, `site:property_landing_update` | matt-review-PR | REFUSE. Canonical house URL is the listing page. |
...
| site-neighborhood-page | `marketing_brain_skills/producers/site-neighborhood-page/` | `site:neighborhood_page_create`, `site:neighborhood_page_update` | matt-review-PR | REFUSE. Live `/cities/[city]/[hood]`. PLACE_PAGES.md. No LP. |
| site-community-page | `marketing_brain_skills/producers/site-community-page/` | `site:community_page_create`, `site:community_page_update` | matt-review-PR | REFUSE. Live `/communities/[slug]`. Do not use `public/lp/tetherow` as exemplar. |
...
| expired-listing-lp | `marketing_brain_skills/producers/expired-listing-lp/` | `content:expired-listing-audit`, `content:expired-listing-lp-update` | matt-review-draft | REFUSE as LP kit. Page is `/sell/expired`. SITE_PAGES.md. |
| site-subdivision-page | `marketing_brain_skills/producers/site-subdivision-page/` | `site:subdivision_page_create`, `site:subdivision_page_update` | matt-review-PR | REFUSE. Live `/subdivisions/[slug]`. No `/lp/tetherow/heath`. |
...
| ops-manychat | `marketing_brain_skills/producers/ops-manychat/` | `ops:manychat_setup`, `ops:manychat_pause`, `ops:manychat_update` | matt-explicit | Configures ManyChat IG keyword automation per listing (SHOWING / OPENHOUSE / DETAILS / `<street>`). Captures lead via CRM inbound (`sendEvent`). Documented: 5 showings/mo → 23 showings/mo after setup |
