...
> All development routes through THE LOOP v1.2.0 — see [docs/DEVELOPMENT_PROCESS.md](../../docs/DEVELOPMENT_PROCESS.md). Every producer inherits its preflight contract, verification bar, and approval model.
