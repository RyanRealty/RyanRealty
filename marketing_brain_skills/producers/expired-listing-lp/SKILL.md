...
2. `docs/archive/fub-era/README.md`. Archived LP voice research. Not a build target. Live capture is `sendEvent` → `crm_people`.
...
- `docs/archive/fub-era/README.md`. Archived LP voice research. Not a build target.
