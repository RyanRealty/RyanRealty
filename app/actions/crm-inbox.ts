  ...
  try {
    const msg = await client.messages.create({
      ...
      system: [
        ...
        'Banned words: stunning, gorgeous, charming, nestled, boasts, dream home, truly, luxurious, delve, seamless, elevate, vibrant, curated. No manufactured urgency: never rush the reader to respond quickly or suggest they will lose an opportunity by waiting.',
