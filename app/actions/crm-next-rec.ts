...
/**
 * Broker "recommended next step" preview for the console quick-action sheet.
 *
 * Lives outside app/actions/crm.ts so the admin layout / ConsoleShell do not
 * NFT-pull the governed-send + DAL barrel graph into every protected page
 * (see app/actions/crm-access.ts).
 */
...
/** Resolve a step's subject/body for PREVIEW — mirrors the engine exactly. */
