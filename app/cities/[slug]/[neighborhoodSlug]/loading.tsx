/**
 * Streaming placeholder for /cities/<slug>/<neighborhood>. Shapes match the
 * arriving page: breadcrumb, Instrument, Field. No text.
 */
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-7xl px-5 pb-16 pt-8 sm:px-8">
        <div className={`${BAR} h-4 w-64`} style={{ background: 'var(--v3-wash)' }} />
