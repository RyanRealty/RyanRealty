...
export default async function BuyerLPPage() {
  ...
  return (
    <main className="bg-[#faf8f4] text-[#102742]">
      ...
      {/* ─── B5 · LP ↔ site capture is one system ───────────────────────────
          Same listing_alerts product as city/search free capture — paid LP is
          not a separate funnel. */}
      <section className="border-b-[3px] border-[#102742] bg-[#faf8f4]">
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-12 text-center">
          ...
          <p className="mt-3 text-base leading-relaxed text-[#102742]/85">
            This form writes the same free listing alerts product used across the open site.
            No ad required — enroll anytime from{' '}
            <Link
              href="/search"
