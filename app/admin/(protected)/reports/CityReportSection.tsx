                    ...
                    <div className="overflow-x-auto">
                      <Table className="min-w-[280px] border border-border text-sm">
                        <TableBody>
                          ...
                          <TableRow><TableCell className="border border-border bg-muted px-3 py-2 font-medium">Median sale price</TableCell><TableCell className="border border-border px-3 py-2">${Number(seg.metrics.median_price).toLocaleString('en-US', { maximumFractionDigits: 0 })}</TableCell></TableRow>
                          ...
                          <TableRow><TableCell className="border border-border bg-muted px-3 py-2 font-medium">Median sale $/sqft</TableCell><TableCell className="border border-border px-3 py-2">${Number(seg.metrics.median_ppsf).toLocaleString('en-US', { maximumFractionDigits: 2 })}</TableCell></TableRow>
                ...
                <div className="overflow-x-auto">
                  <Table className="min-w-[320px] border border-border text-sm">
                    <TableBody>
                      ...
                      <TableRow><TableCell className="border border-border bg-muted px-3 py-2 font-medium">Median sale price</TableCell><TableCell className="border border-border px-3 py-2">${Number(metrics.median_price).toLocaleString('en-US', { maximumFractionDigits: 0 })}</TableCell></TableRow>
                      ...
                      <TableRow><TableCell className="border border-border bg-muted px-3 py-2 font-medium">Median sale $/sqft</TableCell><TableCell className="border border-border px-3 py-2">${Number(metrics.median_ppsf).toLocaleString('en-US', { maximumFractionDigits: 2 })}</TableCell></TableRow>
