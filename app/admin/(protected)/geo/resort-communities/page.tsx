      ...
      <Card>
        <CardContent className="space-y-3 p-4">
          <form className="flex flex-wrap items-end gap-2" method="get">
            ...
            {hasFilters && (
              <Button asChild variant="outline" className="h-11">
                <Link href="/admin/geo/resort-communities">Clear</Link>
              </Button>
            )}
          </form>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              <Link href={`/admin/geo/resort-communities${buildQuery(params, { view: undefined, page: undefined })}`}>
                All
              </Link>
            </Button>
            <Button
            ...
            >
              <Link href={`/admin/geo/resort-communities${buildQuery(params, { view: 'resort', page: undefined })}`}>
                Resort &amp; master plan
              </Link>
            </Button>
          </div>
          ...
          {total === 0 ? (
            ...
            <div className="rounded-lg border border-dashed border-border bg-muted/40 px-4 py-10 text-center">
              ...
              <Button asChild variant="outline" size="sm" className="mt-3">
                <Link href="/admin/geo/resort-communities">Clear filters</Link>
              </Button>
            </div>
          ) : (
            <>
                  ...
                  <div className="flex items-center gap-2">
                    {page > 1 ? (
                      <Button asChild variant="outline" size="sm">
                        <Link href={`/admin/geo/resort-communities${buildQuery(params, { page: String(page - 1) })}`}>
                          Previous
                        </Link>
                      </Button>
                    ) : (
