/**
 * /housing-market/reports — Central Oregon market reports hub: live per-city
 * data + pre-built sales reports + weekly reports.
 *
 * E-CUT 2026-08-13: collapsed the dual URL space. Implementation lives here.
 * /reports 308s here (next.config + redirect stub). Still KB leftover — not a
 * v3 pass.
 *
