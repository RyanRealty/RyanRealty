    ...
    <section className="section" id="schools" aria-label="Schools">
      <div className="wrap">
        ...
        <p style={{ fontSize: '.8rem', color: 'var(--navy-70)', margin: 0, maxWidth: '44rem' }}>
          School assignments reflect the listings recorded in {displayName}. Each school shown is the
          assignment on at least 70 percent of the listings that carry one. Confirm enrollment and
          boundaries with the district. Source: Oregon Data Share via Ryan Realty.
        </p>
      </div>
    </section>
  )
