 ...
 * one control). The payment math lives in MortgageCalculator, so that form
 ...
 * or URL prefill.
 *
 * max-width uses --v3-measure (72rem), not --v3-measure-sheet (40rem). A
 * payment form is not one question. The 40rem sheet measure is for progressive
 * capture.
 */
